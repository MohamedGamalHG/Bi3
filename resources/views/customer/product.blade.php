                            ...
                            <div class="row-cols-auto">
                                <div class="col-md-4">
                                    <form method="post" action="{{route('filter_product')}}">
                                        @csrf
                                        <input type="number" min="0" name="min_price" class="mb-4" placeholder="min..">
                                        <input type="number" min="0" name="max_price" class="mt-4 mb-2" placeholder="max..">
                                    ...
                                    <div class="product-item bg-light">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <h4 class="card-title"><a href="single.html">{{$product->price}}</a></h4>
